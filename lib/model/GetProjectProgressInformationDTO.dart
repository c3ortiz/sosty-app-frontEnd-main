class ProjectProgressInformation {
  String? investmendID;
  int? amountInvested;
  String? projectName;
  String? projectCode;
  ...
  ProjectProgressInformation(
      ...
      this.contactEmail,
      this.events});
  ProjectProgressInformation.fromJson(Map<String, dynamic> json) {
...
class Weights {
  ...
  String? projectID;
  int? pesoManada;
  int? cantidadDeAnimalesGanananDe0a7;
  int? cantidadDeAnimalesGanananDe7a10;
  int? cantidadDeAnimalesGanananMasDe10;
  String? weightDate;
  String? createDate;
  Null? deleteDate;
  Weights(
