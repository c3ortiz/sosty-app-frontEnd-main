class UserInformation {
  ...
  Null? projects;
  Null? truoraCheckId;
  Null? truoraCheckScore;
  Null? truoraPdf;
  Null? truoraCheckDate;
  String? emailConfirmationCode;
  bool? emailConfirmed;
  Null? emailConfirmationDate;
  ...
  Null? arrivalChannel;
  Null? siigoCustomerID;
  Null? siigoCustomerStatus;
  Null? siigoCustomerStatusMessage;
...
class ProfileDetails {
  ...
  Null? gender;
  Null? description;
  Null? patrimonyAmount;
  Null? bankAccountNumber;
  Null? bankAccountType;
  Null? bankAccountBank;
  Null? bankAccountCertificationUrl;
  Null? producerFormatUrl;
  Null? investorFormatUrl;
  Null? clientFormatUrl;
  Null? rutUrl;
  Null? chamberOfCommerceUrl;
  Null? declaracionDeRentaUrl;
  Null? motivationToInvest;
  Null? phraseIdentifiesMe;
  Null? knowledgeAboutCattleRaising;
  Null? holdingTaxEnabled;
